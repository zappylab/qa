...
RSpec::Core::RakeTask.new(:testing) do |t|
  ...
  t.rspec_opts = "--format progress --format RspecJunitFormatter --out test_spec.xml --format html --out test_spec.html"
end
...
task :test => :testing	# this task describe protocols workflow: ... 